...
_C.MODEL.MIDDLE_HEAD.GM.WITH_SEMANTIC_COMPLETION = True
...
_C.MODEL.MIDDLE_HEAD.GM.WITH_SCORE_WEIGHT = False
_C.MODEL.MIDDLE_HEAD.GM.WITH_NODE_DIS = True

# loss weight
_C.MODEL.MIDDLE_HEAD.GM.NODE_LOSS_WEIGHT = 1.0
_C.MODEL.MIDDLE_HEAD.GM.MATCHING_LOSS_WEIGHT = 0.1
_C.MODEL.MIDDLE_HEAD.GM.NODE_DIS_WEIGHT = 0.1
_C.MODEL.MIDDLE_HEAD.GM.NODE_DIS_LAMBDA = 0.02

# SIGMA++
_C.MODEL.MIDDLE_HEAD.GM.WITH_HyperGNN = False
_C.MODEL.MIDDLE_HEAD.GM.HyperEdgeNum = 9
