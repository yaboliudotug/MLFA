...
class PrototypeComputation(object):
    ...
    def compute_targets_for_locations(self, locations, targets, object_sizes_of_interest):
        ...
        for im_i in range(len(targets)):
            ...
            # print(bboxes.shape, reg_targets_per_im.shape, labels_per_im.shape)
            # print(bboxes)
            # try:
...
color_hub = [(255,255,255),(199,72,20),(255,0,0),(0,255,0),(0,0,255),(255,127,80),(255,0,255),(0,119,140), (160, 82,45)]
